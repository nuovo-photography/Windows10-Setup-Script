...
Function KrispDownload {
	Write-Output "Downloading krisp...."
	
	Invoke-WebRequest -Uri "https://cdn.krisp.ai/win/release/v1.31/krisp-v1.31.4-x64.msi" -Outfile "$env:USERPROFILE\Downloads\Krisp.msi"
	
	Write-Output "Downloading krisp completed...."
}
...
Function SetDafaultBrowserChrome {
	Write-Output "Setting Default Browser...."
	choco install setdefaultbrowser --version=1.3 -y --ignore-checksums
...
function SetLockScreen {
    Write-Output "Lock Screen Changing..."
	...
	try {
		...
		$LockScreenImageValue = "C:\temp\NuovoLockScreen.png"
		...
		Write-Output $RegKeyPath
		
		Write-Output $LockScreenImageValue
		
		Set-ItemProperty -Path $RegKeyPath -Name $LockScreenStatus -Type DWORD  -Value $StatusValue -Force 
		Set-ItemProperty -Path $RegKeyPath -Name $LockScreenPath  -Type STRING -Value $LockScreenImageValue -Force 
		Set-ItemProperty -Path $RegKeyPath -Name $LockScreenUrl -Type STRING -Value $LockScreenImageValue -Force
		

		Write-Output "Lock Changes done...."
	}
	catch {
...
Function InstallTeamViewer {
	Write-Output "Installing team viewer..."
	choco install teamviewer.host -y --force --ignorechecksums
}

Function DownloadNordPass {
	Write-Output "Downloading Nord Pass..."
	Start-BitsTransfer -Source "https://downloads.npass.app/windows/NordPassSetup.exe" -Destination "$env:USERPROFILE\Downloads\NordPassSetup.exe"
}

Function InstallNordPass {
	Write-Output "Installing Nord Pass..."
	##choco install nordpass -y --force --ignorechecksums
	Start-Process -FilePath "$env:USERPROFILE\Downloads\NordPassSetup.exe" -ArgumentList --silent -Verb RunAs
}

Function DownloadNordLayer {
	Write-Output "Downloading Nord Layer...."
	
	Start-BitsTransfer -Source "https://downloads.nordlayer.com/win/releases/NordLayerSetup_v2.8.1.msi" -Destination "$env:USERPROFILE\Downloads\NordLayerSetup_v2.8.1.msi"

}

Function InstallNordLayer {
	Write-Output "Installing Nord Layer...."
	msiexec /i "$env:USERPROFILE\Downloads\NordLayerSetup_v2.8.1.msi" /q 
}

Function InstallKrisp {
	Write-Output "Installing Krisp...."
	msiexec /i "$env:USERPROFILE\Downloads\Krisp.msi" /q 
}

Function AllignTaskBarLeft {
	Write-Output "Allign Task Bar to the left..."
	$taskbarPath = "HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced"
    Set-ItemProperty -Path $taskbarPath -Name "TaskbarAl" -Value 0 -Force
    Stop-Process -name explorer
}

Function AllignTaskBarMiddle {
	$taskbarPath = "HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced"
    Set-ItemProperty -Path $taskbarPath -Name "TaskbarAl" -Value 1 -Force
    Stop-Process -name explorer
}

Function RunUpdates {
	Write-Output "Running for windows update...."
...
Function TurnOffTaskView {
	Write-Output "Turning off taks view from taskbar...."
...
Function TurnOffWidget {
	Write-Output "Removing widget second try...."
	Get-AppxPackage *WebExperience* | Remove-AppxPackage
}

Function TurnOffChat {
	Write-Output "Removing chat from taskbar...."
...
Function TurnOffSearch {
	Write-Output "Removing search from taskbar...."
	Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Search" -Name "SearchboxTaskbarMode" -Value 0 -Force
}

Function DownLoadFrancaisCanadaLang {
	Write-Output "Downloading Francais Canadian language...."
	$LangList = Get-WinUserLanguageList
	$LangList.Add("fr-CA")
	Set-WinUserLanguageList -LanguageList $LangList -Force
}

Function SetFrancaisCanadaLangAsKeyBoardLayout {
	Write-Output "Changing the keyboard layout to Francais Canadian language...."
	Set-WinUserLanguageList -LanguageList fr-CA -Force
}

Function RestartComputerEverySunday5Am {
	Write-Output "Scheduling pc for restart on every sunday 5.00AM...."
	$trigger = New-ScheduledTaskTrigger -Weekly -DaysOfWeek Sunday -At 5:00am
	$action = New-ScheduledTaskAction -Execute 'shutdown' -Argument '/r /f'
	Register-ScheduledTask -TaskName "RestartComputer" -Trigger $trigger -Action $action -RunLevel Highest -Force
}

Function ConnectWifi {
    Write-Output "Connecting to the wifi..."
	
	$WiFiProfilePath = 'C:\temp\Wi-Fi-Profile.xml'
	
	# Get the list of all wireless network profiles
	$existingProfiles = netsh wlan show profiles | Select-String "All User Profile\s*:\s*(.*)" | ForEach-Object { $_.Matches.Groups[1].Value }
    $profileToSearch = (Get-Content $WiFiProfilePath | Select-String -Pattern "<name>(.*)</name>" | ForEach-Object { $_.Matches.Groups[1].Value })[0]
	# Check if the desired WiFi profile is already imported
	if ($existingProfiles -contains $profileToSearch) {
		Write-Host "WiFi profile is already imported."
	}
	else {
		# Import the WiFi profile using netsh
		netsh wlan add profile filename=$WiFiProfilePath
		Write-Host "WiFi profile imported successfully."
	}
	
	netsh wlan connect name=NuovoSSL
}	

Function InstallAdobeCreativeCloud {
	
	Write-Output "Downloading Adobe Creative Cloud......"
	
	
	$Url = "https://drive.google.com/uc?export=download&id=1LPjwiMYQke0w3WGa8yjD2_5B1pIBBxNv&confirm=t"
	$DownloadZipFile = "$env:USERPROFILE\Downloads\CreativeCloudPackage.zip"
	$ExtractPath = "$env:USERPROFILE\Downloads\CreativeCloudPackage"
	Start-BitsTransfer -Source $Url -Destination $DownloadZipFile
	New-Item -ItemType Directory -Path $ExtractPath -Force
	$ExtractShell = New-Object -ComObject Shell.Application 
	$ExtractFiles = $ExtractShell.Namespace($DownloadZipFile).Items() 
	$ExtractShell.NameSpace($ExtractPath).CopyHere($ExtractFiles,  0x14) 
	Start-Process $ExtractPath	
	
	Write-Output "Installing Adobe Creative Cloud......"
	
    Start-Process -FilePath "$env:USERPROFILE\Downloads\CreativeCloudPackage\CreativeCloudSet-Up.exe" -ArgumentList --silent -Verb RunAs
    Write-Output "Creative cloud installed successfully......"
}
...
Function RemoveWindowsBloatware {
	...
	$path = "http://tlu.dl.delivery.mp.microsoft.com/filestreamingservice/files/21a6f30d-0ec0-46da-92cf-04e35cf18efc?P1=1691008660&P2=404&P3=2&P4=jwnrVo6JATJ6YP5cq8Zn%2fLJZ0t5LcSKz8SFdiQsdrR5aNIsckGLz51dBeCsXfKLO4TQsmiAESlLAZPoDz7FwHw%3d%3d"

	Start-BitsTransfer -Source $path -Destination "$env:USERPROFILE\Downloads\xml2.8.appx"

	Add-AppxPackage -Path $env:USERPROFILE\Downloads\xml2.8.appx
	...
	Write-Output "Removing all possible windows default bloatware......"
	...
	Write-Output "Removing Messenger......"
	winget uninstall messenger
	
	Write-Output "Removing Teams/Chat......"
	Get-AppxPackage *Teams* | Remove-AppxPackage
	winget uninstall "microsoft teams" --accept-source-agreements
	
	Write-Output "Uninstalling widget..."
	winget uninstall --id 9MSSGKG348SP
	
	Write-Output "Removing 3D Builder......"
	Get-AppxPackage *3dbuilder* | Remove-AppxPackage 
	
	Write-Output "Removing Sway......"
	Get-AppxPackage *sway* | remove-AppxPackage 
	
	Write-Output "Removing Alarms & Clock......"
	Get-AppxPackage *alarms* | Remove-AppxPackage
	
	Write-Output "Removing Calculator......"
	Get-AppxPackage *calculator* | Remove-AppxPackage
	
	Write-Output "Removing Calendar and Mail......"
	Get-AppxPackage *communicationsapps* | Remove-AppxPackage
	
	Write-Output "Get Office......"
	Get-AppxPackage *officehub* | Remove-AppxPackage
	
	Write-Output "Removing AV1 Codec......"
	Get-AppxPackage *AV1VideoExtension* | Remove-AppxPackage
	
	Write-Output "Removing VP9 Video Extensions......"
	Get-AppxPackage *VP9VideoExtensions* | Remove-AppxPackage
	
	Write-Output "Removing News app......"
	Get-AppxPackage *BingNews* | Remove-AppxPackage
	
	Write-Output "Removing Weather......"
	Get-AppxPackage *BingWeather* | Remove-AppxPackage
	
	Write-Output "Removing Sports......"
	Get-AppxPackage *bingsports* | Remove-AppxPackage
	
	Write-Output "Removing News, Sports, and Weather apps......"
	Get-AppxPackage *bing* | Remove-AppxPackage
	
	Write-Output "Removing WebP image support......"
	Get-AppxPackage *WebpImageExtension* | Remove-AppxPackage
	
	Write-Output "Removing HEIF image support......"
	Get-AppxPackage *HEIFImageExtension* | Remove-AppxPackage
	
	Write-Output "Removing Music app......"
	Get-AppxPackage *ZuneMusic* | Remove-AppxPackage
	
	Write-Output "Removing Movies and TV......"
	Get-AppxPackage *ZuneVideo* | Remove-AppxPackage
	
	Write-Output "Removing Get Help app......"
	Get-AppxPackage *GetHelp* | Remove-AppxPackage
	
	Write-Output "Removing Voice Recorder......"
	Get-AppxPackage *WindowsSoundRecorder* | Remove-AppxPackage
	
	Write-Output "Removing Photos......"
	Get-AppxPackage *photos* | Remove-AppxPackage
	
	Write-Output "Removing MS Office......"
	Get-AppxPackage *MicrosoftOfficeHub* | Remove-AppxPackage
	
	Write-Output "Removing Windows Camera......"
	...
	Write-Output "Removing Your Phone Companion......"
	...
	Write-Output "Removing Screen & Sketch/Snipping tool......"
	Get-AppxPackage *ScreenSketch* | Remove-AppxPackage
	
	Write-Output "Removing Spotify......"
	Get-AppxPackage *SpotifyAB.SpotifyMusic* | Remove-AppxPackage
	
	Write-Output "Removing Microsoft To-Do......"
	...
	Write-Output "Removing Screen Sketch......"
	Get-AppxPackage *ScreenSketch* | Remove-AppxPackage
	
	Write-Output "Removing Clip Champ......"
	Get-AppxPackage *Clipchamp* | Remove-AppxPackage
	
	Write-Output "Removing Clipchamp......"
	Get-AppxPackage *Clipchamp* | Remove-AppxPackage
	...
	Write-Output "Removing I Your Phone......"
	Get-AppxPackage *YourPhone* | Remove-AppxPackage
	
	Write-Output "Removing Instagram ......"
	Get-AppxPackage *instagram* | Remove-appxPackage
	
	Write-Output "Removing LinkedIn......"
	Get-AppxPackage *LinkedIn* | Remove-appxPackage
	

	
	Write-Output "Removing WhatsApp......"
	Get-AppxPackage *WhatsApp* | Remove-appxPackage
	
	Write-Output "Removing PrimeVideo......"
	Get-AppxPackage *PrimeVideo* | Remove-appxPackage
	
	Write-Output "Removing Sudoku......"
	Get-AppxPackage *Sudoku* | Remove-appxPackage
	
	Write-Output "Removing minecraft......"
